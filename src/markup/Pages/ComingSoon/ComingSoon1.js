...
const ComingSoon = () => {
	...
	const startTimer = () =>{
		...
		WebsiteLaunchDate.setMonth(WebsiteLaunchDate.getMonth() + 1/2);
				...
				<div className="coming-soon bg-light" style={{backgroundImage:"url("+ bnr + ")", backgroundPosition: "center", backgroundSize: "cover" }}>
					<div className="countdown-box">
						<div className="button-home">
							<Link to={"./"} className="btn btn-primary"><i className="fa fa-home"></i> dileepchauhan25@gmail.com</Link>
						</div>
						<div className="countdown">
							<div className="date">
								<span className="time days text-primary">{2}</span>
					...
					<div className="coming-head">
						<h2><span>Will be back</span><strong>soon...</strong></h2>
